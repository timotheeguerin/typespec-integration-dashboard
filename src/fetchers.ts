import type { GitHubPipeline, ADOPipeline, RunResult } from "./pipelines.js";
...
export async function fetchADORuns(pipeline: ADOPipeline): Promise<RunResult[]> {
